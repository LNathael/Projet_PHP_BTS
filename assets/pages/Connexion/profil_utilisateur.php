        ...
        <section class="section">
            <div class="box">
                ...
                <?php if (!empty($user['photo_profil'])): ?>
                    <img src="../../<?= htmlspecialchars($user['photo_profil']); ?>" alt="Photo de profil" style="max-width: 150px; max-height: 150px; border-radius: 10%;">
                <?php else: ?>
                    <img src="../../uploads/profils/default.png" alt="Photo de profil par défaut" style="max-width: 150px; max-height: 150px; border-radius: 50%;">
                <?php endif; ?>
